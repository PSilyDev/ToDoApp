        ...
        <div className="lg:bg-black grid grid-rows-12 rounded-md">
            {
                ...
                :
                <>
                    <div className="lg:visible row-span-2 w-full h-full mt-6 lg: mb-10 sm: hidden lg:block">
                    ...
                    <div className="lg:row-start-3 row-span-10 mg-10 sm: row-start-1">
                        <div className="w-9/12 mx-auto h-full lg:my-10">
                            {
