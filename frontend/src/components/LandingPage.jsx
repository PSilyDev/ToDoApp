export const LandingPage = () => {
    ...
    return(
        <div className="w-screen h-screen bg-gradient-to-r from-black via-gray-900 to-black grid grid-cols-12">
            ...
            <div className="col-span-5">
                <p className="mt-64 ml-10 text-8xl font-bold text-blue-600/100 dark:text-blue-500/100">checklist.</p>

                <p className="mt-10 ml-10 text-4xl font-medium text-white">Checklist helps you keep track of your to-dos and organize your tasks effortlessly</p>
